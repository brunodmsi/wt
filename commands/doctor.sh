...
cmd_doctor() {
    ...
    case "$_doctor_mux" in
        ...
        herdr) _doctor_warn "Active multiplexer: herdr (opens a tab via 'herdr tab create'; services run as bg processes, multi-pane layout is not reproduced inside the tab — see issue #10)" ;;
